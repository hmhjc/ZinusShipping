...
import cn.zinus.shipping.Adapter.StockLotCheckDetailListViewAdapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_search:
                actionSearch();
                //getStockLotCheckDetailbyCheckMonth("INB-2017090600001");
                break;
        }
    ...
    public void getStockLotCheckDetailbyCheckMonth(StockCheckData stockCheck) {
        ...
        if (cursorDatalist.getCount() != 0) {
            while (cursorDatalist.moveToNext()) {
                ...
                stockLotCheckDeatilData.setCONSUMEABLDEFNAME(cursorDatalist.getString(cursorDatalist.getColumnIndex(Constant.CONSUMABLEDEFNAME)));
